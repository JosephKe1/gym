...
- **Weekly schedule** — a Mon–Sun plan with workouts assigned per day, complete/missed/rest states, and a "today" banner. Comes seeded with a 5-day Upper/Lower/Push/Pull/Legs split; everything is editable.
...
- **Settings** — lb/kg, default rest duration, JSON export/import backup, full reset.
